con.controller('kuvarPocetnaController',['$scope','$location','registrovanjeMenadzeraService','logovanjeService','$mdDialog','$route', function($scope,$location,registrovanjeMenadzeraService,logovanjeService,$mdDialog,$route){
