...
public interface MealOrderListRepository extends JpaRepository<MealOrderList, Integer>{
	...
	public Integer setIsServedIPaidForMealOrderList(Boolean isServed, Boolean isPaid, Integer id, Zaposleni waiter, String datePaid);
	...
	public Collection<MealOrderList> findByRestaurantIdAndWaiter(Integer restaurantId, Zaposleni waiter);
